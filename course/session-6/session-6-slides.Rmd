...
sp <- data(varespec_s6, package = "edcpR")
env <- data(varechem_s6, package = "edcpR")
...
There is NO assignment for this week's session:
 ...
 - Online after the session on classification (December 3)
 
Remember to upload Assignment 4 (Relationships & Comparing Means) by next week: **November 18, 12 pm (= at noon!)**
