...
vegdata[complete.cases(vegdata),] # doens't do anything
# vs
vegdata <- vegdata[complete.cases(vegdata), ] # this does


identify(vegdata$Elevation) #the rows containing the outliers are row 14 and 98
#row 14 and 98 should be deleted and the new dataframe should be named differently
my_df_2 <- my_df_1[-c(14,98), ]

#vs
my_df_2 <- my_df_1[!my_df_1$Elevation>150,]
