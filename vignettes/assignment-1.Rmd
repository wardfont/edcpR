...
- **Annotate** your script by using `#`.
- You will be graded on:
  - The **correctness** of your answers.
  - The **efficiency** of your code. Don't make your script unnecessarily long and only do the essential tasks.
  - The **clarity** of your code. Make sure you explain the steps in your script with annotations (`#`)
...
Remember to delete any line of code with **setwd()**. Save your R-script as **Surname_FirstName_Task1.R**. Upload this on Toledo before **September 30, 12 am** in the assignments folder!
